    ...
    def _create_default_website(self):
        return Website(
            ...
            website_navigation=NavigationXPaths(
                ...
                search_result_products_xpath_templates="""/html/body/rz-app-root/div/div[1]/rz-category/div/main/rz-catalog-layout/div[2]/section/rz-category-goods//rz-product-tile/div/a[2] 
                | /html/body/rz-app-root/div/div[1]/rz-search/rz-catalog/div/div[2]/section//rz-button-product-page[2]/rz-indexed-link/a 
                | /html/body/rz-app-root/div/div[1]/rz-brand/div/main/rz-catalog/div/div/section/rz-grid/ul//rz-catalog-tile/app-goods-tile-default/div/div[2]/div[1]/rz-button-product-page[2]/rz-indexed-link/a""",                    
